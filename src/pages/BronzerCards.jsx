...
function BronzerCards() {
    const [bronzerData, setBronzerData] = useState([]);
  
    useEffect(() => {
      axios.get('https://makeup-api.herokuapp.com/api/v1/products.json?product_type=bronzer')
        .then(response => {
          setBronzerData(response.data);
        })
        .catch(error => {
  ...
  return (
    <div>
      ...
      <h1>Bronzer Products</h1>
      <hr></hr>
      <div className="card-container">
        {bronzerData.map((item, index) => (
